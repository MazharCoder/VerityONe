    ...
    <header className="bg-white h-16 border-b border-gray-200 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-10">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 max-w-xl relative">
          ...
          />
          <Search className="absolute left-3 top-2.5 text-gray-400 hidden md:block" size={18} />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        >
          ...
          <span className="font-medium text-sm text-gray-700 hidden sm:block">John Doe</span>
        </div>
      </div>
    </header>
  );
